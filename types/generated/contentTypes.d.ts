...
export interface ApiGeneralSettingGeneralSetting extends Schema.SingleType {
  ...
  info: {
    ...
    displayName: '\u0417\u0430\u0433\u0430\u043B\u044C\u043D\u0456 \u041D\u0430\u043B\u0430\u0448\u0442\u0443\u0432\u0430\u043D\u043D\u044F';
    description: '';
  };
  options: {
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    ...
    courseAuthor: Attribute.Component<'course-author.course-author'>;
    sertificates: Attribute.Component<'sertificates.sertificates'>;
    reviews: Attribute.Component<'reviews.reviews'>;
    courseStudy: Attribute.Component<'course-study.course-study'>;
    quote: Attribute.Component<'quote.author-quote'>;
    courseConcept: Attribute.Component<'course-concept.course-concept'>;
    faq: Attribute.Component<'faq.faq'>;
    collapsibleCounter: Attribute.Component<'collapsible-counter.collapsible-counter'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPurchaseFormPurchaseForm extends Schema.CollectionType {
  collectionName: 'purchase_forms';
  info: {
    singularName: 'purchase-form';
    pluralName: 'purchase-forms';
    displayName: '\u0424\u043E\u0440\u043C\u0430 "\u041F\u0440\u0438\u0434\u0431\u0430\u0442\u0438 \u043A\u0443\u0440\u0441" ';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    promocode: Attribute.Relation<
      'api::purchase-form.purchase-form',
      'oneToOne',
      'api::promocode.promocode'
    >;
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::purchase-form.purchase-form': ApiPurchaseFormPurchaseForm;
    }
  }
}
